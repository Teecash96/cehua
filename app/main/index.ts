...
async function createMainWindow() {
  ...
  // Sidebar library + a document-style workspace with a signature flow diagram.
  // Needs room to breathe; min keeps sidebar + workspace usable side by side.
  const minWindowWidth = 860;
  const minWindowHeight = 580;
